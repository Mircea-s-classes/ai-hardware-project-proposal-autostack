...
1. Loads a trained YOLO model (best.pt)
2. Runs inference on an input image
3. Measures inference execution time
4. Measures average CPU usage
5. Measures peak CPU usage
6. Saves the detection output image
